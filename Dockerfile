...
RUN mkdir -p /TEMP/lscsoft && cd /TEMP/lscsoft && git clone https://git.ligo.org/lscsoft/lalsuite.git && git checkout master && cd lalsuite && ./00boot && ./configure && make install -j
